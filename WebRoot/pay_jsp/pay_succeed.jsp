    ...
    <div class="paysuccess">
        <div class="success">
            ...
            <div class="paydetail">
                ...
                <p class="button"><a href="${pageContext.request.contextPath}/index.jsp" class="sui-btn btn-xlarge btn-danger">查看订单</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/index.jsp" class="sui-btn btn-xlarge ">返回首页</a></p>
            </div>
        </div>
